      ...
      <CCol :md="12">
        <CCard class="mb-4">
          <CCardBody>
            <CRow>
              <CCol :sm="5">
                <h4 id="traffic" class="card-title mb-0">Trafique</h4>
                <div class="small text-body-secondary">Janvier - Juillet 2024</div>
              </CCol>
          ...
          <CCardFooter>
            ...
            >
              <CCol>
                <div class="text-body-secondary">Disponibilité</div>
                <div class="fw-semibold text-truncate">25 </div>
                <CProgress class="mt-2" color="success" thin :precision="1" :value="25" />
              </CCol>
              <CCol>
                <div class="text-body-secondary">Réservation</div>
                <div class="fw-semibold text-truncate">24.093 Users (20%)</div>
                <CProgress class="mt-2" color="info" thin :precision="1" :value="20" />
              </CCol>
              <CCol>
                <div class="text-body-secondary">Consultation</div>
                <div class="fw-semibold text-truncate">78.706 </div>
                <CProgress class="mt-2" color="warning" thin :precision="1" :value="60" />
              </CCol>
              <CCol>
                <div class="text-body-secondary">Nouveau Utilisateur</div>
                <div class="fw-semibold text-truncate">22.123 </div>
                <CProgress class="mt-2" color="danger" thin :precision="1" :value="80" />
              </CCol>
              <CCol class="d-none d-xl-block">
                <div class="text-body-secondary">Bénéfice</div>
                <div class="fw-semibold text-truncate">Environ 30%</div>
