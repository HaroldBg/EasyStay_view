...
const items = [
  ...
  },
  {
    ...
    number: '+229 96789012',
    mail: 'robert.taylor@example.com'
  },
  {
    mat: 8,
    client:{
    ...
    number: '+229 97890123',
    mail: 'sophia.miller@example.com'
  },
  {
    mat: 9,
    client:{
...
<template>
  ...
  <div class="mt-4">
    ...
    <CTable caption="top" hover >
      <CTableCaption class="fs-3">Liste des clients</CTableCaption>
      <CTableHead>
        <CTableRow>
      ...
      <CTableBody>
        ...
        <CTableRow  v-for="item in items" :key="item.name">
          ...
          <CTableDataCell class="py-3">{{ item.mail }} </CTableDataCell>
